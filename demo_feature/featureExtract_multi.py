...
print("feature process1")
# Main path to the caffe installation
caffe_root = '/home/Uihyeop/caffe/'

# Model prototxt file
model_prototxt = caffe_root + 'models/ResNet/ResNet-50-deploy.prototxt'

# Model caffemodel file
model_trained = caffe_root + 'models/ResNet/ResNet-50-model.caffemodel'
...
if __name__ == "__main__":
	...
	pool = Pool(processes=8)
        print(pool.map(main(sys.argv[1:]),[1,2,3,4,5,6,7,8]))
