...
ap.add_argument("-p","--shape-predictor", required=True, help="path to pretrained facial landmark predictor")
...
ap.add_argument("-i3", "--imagePath3", required=True, help="path to input image")
ap.add_argument("-i4", "--imagePath4", required=True, help="path to input image")
ap.add_argument("-i5", "--imagePath5", required=True, help="path to input image")
ap.add_argument("-i6", "--imagePath6", required=True, help="path to input image")
ap.add_argument("-i7", "--imagePath7", required=True, help="path to input image")
ap.add_argument("-i8", "--imagePath8", required=True, help="path to input image")
...
def task(split):
    for baseroot, basedirs, basefiles in os.walk(args["imagePath"+str(split)]):
...
if __name__ == '__main__':
    ...
    print(pool.map(task,[1,2,3,4,5,6,7,8]))
