...
# self.label.setGeometry(QtCore.QRect(30, 750, 411, 81))
...
class VideoBox(QWidget):
    ...
    def __init__(self, video_url="", video_type=VIDEO_TYPE_OFFLINE, auto_play=False):
        ...
        self.video_url = video_url # video 디렉토리
        self.video_type = video_type  # 0: offline  1: realTime
        self.auto_play = auto_play
        self.status = self.STATUS_INIT  # 0: init 1:playing 2: pause

        self.pictureLabel = QLabel()
        init_image = QPixmap("gui/cat.jpeg").scaled(self.width(), self.height())
